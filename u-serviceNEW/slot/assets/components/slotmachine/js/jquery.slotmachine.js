...
(function(jQuery, window, document, undefined){
    ...
    SlotMachine.prototype.getTileOffset = function(index){
        ...
        for(var i=0; i<index; i++){
            offset += jQuery( this.$tiles.get(i) ).outerHeight();
        }
    ...
    SlotMachine.prototype.isVisible = function(){
        ...
        var above = this.$slot.offset().top > jQuery(window).scrollTop() + jQuery(window).height(),
            below = jQuery(window).scrollTop() > this.$slot.height() + this.$slot.offset().top;
